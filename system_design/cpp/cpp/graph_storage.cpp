...
//        mapped_edges_dst_sort = merge_sorted_edge_buckets(mapped_edges_dst_sort, in_mem_edge_bucket_starts_dst, buffer_size, false);
        ...
        current_subgraph_state_->in_memory_subgraph_ = new CeleritasGraph(mapped_edges, mapped_edges_dst_sort, getNumNodesInMemory(), num_hash_maps);
...
//        EdgeList dst_sort = src_sort.index_select(0, torch::argsort(src_sort.select(1, -1)));
        ...
        current_subgraph_state_->in_memory_subgraph_ = new CeleritasGraph(src_sort, dst_sort, getNumNodesInMemory(), num_hash_maps);
    }
}
...
//    mapped_edges_dst_sort = merge_sorted_edge_buckets(mapped_edges_dst_sort, in_mem_edge_bucket_starts_dst, buffer_size, false);
    ...
    subgraph->in_memory_subgraph_ = new CeleritasGraph(mapped_edges, mapped_edges_dst_sort, getNumNodesInMemory(), num_hash_maps);
