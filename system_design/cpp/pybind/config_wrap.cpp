...
void init_config(py::module &m) {
    ...
    py::class_<CeleritasConfig, std::shared_ptr<CeleritasConfig>>(m, "CeleritasConfig")
        .def_readwrite("model", &CeleritasConfig::model)
        .def_readwrite("storage", &CeleritasConfig::storage)
        .def_readwrite("training", &CeleritasConfig::training)
        .def_readwrite("evaluation", &CeleritasConfig::evaluation);
