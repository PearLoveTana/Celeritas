#ifndef CELERITAS_GRAPH_H_
#define CELERITAS_GRAPH_H_
...
class CeleritasGraph  {
  public:
    ...
    CeleritasGraph(EdgeList src_sorted_edges, EdgeList dst_sorted_edges, int64_t num_nodes_in_memory, int num_hash_maps);
...
class GNNGraph : public CeleritasGraph {
  public:
