#ifndef CELERITAS_GRAPH_STORAGE_H
#define CELERITAS_GRAPH_STORAGE_H
...
struct InMemorySubgraphState {
    ...
    CeleritasGraph *in_memory_subgraph_;
};
...
class GraphModelStorage {
  ...
  public:
    ...
    void initializeInMemorySubGraph(torch::Tensor buffer_state, int num_hash_maps);
